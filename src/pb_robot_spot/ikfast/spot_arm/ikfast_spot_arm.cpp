...
static struct PyModuleDef ikfast_spot_arm_module = {
    PyModuleDef_HEAD_INIT,
    "ikfast_spot_arm",   /* name of module */
...
PyMODINIT_FUNC
PyInit_ikfast_spot_arm(void)

#else // PY_MAJOR_VERSION < 3
#define INITERROR return

PyMODINIT_FUNC
initikfast_spot_arm(void)
#endif
{
#if PY_MAJOR_VERSION >= 3
    PyObject *module = PyModule_Create(&ikfast_spot_arm_module);
#else
    PyObject *module = Py_InitModule("ikfast_spot_arm", ikfast_methods);
#endif
